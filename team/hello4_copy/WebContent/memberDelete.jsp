<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%><%@page import="test.dev.vo.MemberVO"%>
<!doctype html>
<html lang="ko">
<head>
...
<img style="margin-top:5vw; width:50vw; padding:0.5vw;" src="images/main/m3.jpg"/>


<% MemberVO person = (MemberVO)request.getAttribute("person");
   if(person != null) { %>
   <div style="border:1px dotted #4E0379; width:45vw;  margin-bottom:1vw; margin-left:3vw;margin-top:2vw">
		
	
	    <form action="memberDelete.do" method="post">
	    <h3>검색 정보 결과</h3>
		<h2 style="margin-left:-13vw">${person.id } / ${person.passwd } / ${person.name } / ${person.mail } </h2><p>
	       <input type="hidden" name="id"  value="${person.id}" />
<input type="submit" style="margin-top:-3vw; width:10vw;height:3vw; margin-left:32vw;" value="삭제하기"/>  

	    </form>
	</div>
<%}else{ %>
    <h4 style="color:purple; font-size:2vw; margin-top:3vw; margin-bottom:3vw"> ${result}</h4> <p>
