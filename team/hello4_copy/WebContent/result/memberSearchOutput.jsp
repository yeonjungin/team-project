...
<section>
		 <table class="type10"><thead>
	   		<tr><th scope="cols">ID</th><th scope="cols">비밀번호</th><th scope="cols">이름</th><th scope="cols">이메일</th></tr></thead>
			<%
    	...
    	<div style="margin-bottom:10vw; margin-top:3vw"></div> 	
