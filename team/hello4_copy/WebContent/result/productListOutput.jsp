...
<body class="home">
  ...
  <nav id="menu" class="menu">
	...
	<%  ArrayList<ProductVO> listOfProducts = (ArrayList<ProductVO>)request.getAttribute("listOfProducts"); 
    if(!listOfProducts.isEmpty()) {  %>
    
	   <table class="type10"><thead>
	   		<tr><th >상품분류</th><th >상품코드</th><th>상품명</th><th>가격</th><th>상세정보</th></tr></thead>
	   		
			
			<%   for(int i=0; i<listOfProducts.size(); i++){   
				ProductVO product = listOfProducts.get(i);   %>
			       <tbody>
			        <tr><td class="even"><%=product.getDivision() %></td>
    	   ...
    	   out.print("<h3>등록된 상품 정보가 없습니다.</h3>");
       }
	%>
	  </table>
