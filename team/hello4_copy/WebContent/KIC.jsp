   ...
   <div id="event" style="margin-bottom:-1vw; width:auto">
    ...
    <header id="header">
        ...
        <div id="top-bar">
            ...
            <div class="container">
             <a href="./outside/mainpage2.jsp"><h3 style="color:white; width:15vw;font-size:2.7vw;  margin-left:0vw; margin-top:3.3vw">용용전자</h3></a>
...
<div style="display:inline-block; margin-top:5vw; margin-left:0.6vw; margin-bottom:8vw">
		...
		<%
			...
			while(rs.next()){		
		%>
		<%if(rs.getString("P_DIVISION").equals("KIC")){%>
			<div style="width:30vw;display:inline-block; margin:1.2vw; text-align:center">
			<img src="images/pro/<%=rs.getString("P_FILENAME")%>" style="margin-left:1.2vw; width:25vw;">			
			<h3 style="color:black; margin-top:0.4vw"><%=rs.getString("P_NAME")%></h3>
			<h3 style="color:#986FD2; margin-top:-1vw"><%=rs.getInt("P_UNITPRICE")%></h3>
			<p><a href="subproduct.jsp?id=<%=rs.getString("P_ID")%>" class="btn btn-secondary" role="button" style="background-color:#926AC8"> 상세 정보 &raquo;</a>
			</div>
		<%} %><%} %>
