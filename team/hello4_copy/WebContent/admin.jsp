...
<head>
    ...
    <link rel="stylesheet" href="css/style-fraction.css">
    <link rel="stylesheet" href="css/animate.css"/>
    <link rel="stylesheet" href="css/first_member_page.css">
    <style>
    #admin1 a{ display:inline-block; background:#76577D; color:white; text-align:center; vertical-align:middle; text-decoration:none; font-size:1.1vw; width:14vw; height:3vw; line-height:38px; }
	#admin2 a{ display:inline-block; background:#B186BB; color:white; text-align:center; vertical-align:middle; text-decoration:none; font-size:1.1vw; width:14vw; height:3vw; line-height:38px; }
	#admin3 a{ display:inline-block; background:#CB84DC; color:white; text-align:center; vertical-align:middle; text-decoration:none; font-size:1.1vw; width:14vw; height:3vw; line-height:38px; }
	#admin4 a{ display:inline-block; background:#D2B0D9; color:white; text-align:center; vertical-align:middle; text-decoration:none; font-size:1.1vw; width:14vw; height:3vw; line-height:38px; }
	#admin5 a{ display:inline-block; background:#7708A6; color:white; text-align:center; vertical-align:middle; text-decoration:none; font-size:1.1vw; width:14vw; height:3vw; line-height:38px; }
	#admin_header{text-align:center; font-size:2.5vw;}
	.admin_border{border:1px dotted #cccccc; text-align:center;}
	.admin_border a{text-decoration:none; }
	#list_a{ text-align:center;}
    </style>
...
<body class="home">
   <div id="event" style="margin-bottom:-1vw; width:auto">
    ...
    <header id="header">
        ...
        <div id="top-bar">
            ...
            <div class="container">
                 <a href="./outside/mainpage2.jsp"><h3 style="color:white; width:15vw;font-size:2.7vw;  margin-top:2.8vw; margin-left:-1vw">용용전자</h3></a>
  ...
  <nav id="menu" class="menu">
	...
	<div id="admin_header" style="margin-top:3vw">
	
	<br>ADMIN PAGE<br></div>
	<div>
	<br><br>
	</div>
    ...
    <div class="admin_border" >
     	<h3>* 회원 관리 *</h3>
    	<div id="admin1" style="margin-top:2vw"><a href="Register.jsp">회원 정보 생성</a><p></div>
    	<div><p></div>
		<div id="admin2"><a href="memberSearch.jsp">회원 정보 검색</a> <p> </div>
		<div><p></div>
		<div id="admin3"><a href="memberUpdate.jsp">회원 정보 수정</a>  <p></div>
		<div><p></div>
		<div id="admin4"><a href="memberDelete.jsp">회원 정보 삭제</a> <p></div>
		<div><p></div>
		<div id="admin5"><a href="memberList.do">모든 회원 정보 보기</a><br></div>
		<div><p></div>
		<hr>
		<h3>* 상품 관리 *</h3>
		<div id="admin5"><a href="productInsert.jsp">상품 등록 하기</a><br></div>
		<div><p></div>
		<div id="admin2"><a href="productSearch.jsp">상품 검색 하기</a><br></div>
		<div><p></div>
		<div id="admin2"><a href="productList.do">상품 목록 확인 하기</a><br></div>
		<div><p></div>
		<div id="admin2" style="margin-bottom:4vw"><a href="productDelete.jsp">상품 삭제 하기</a><br></div>
		<div><p></div>
