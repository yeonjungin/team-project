...
<div style="border:1px dotted #4E0379; text-align:center; width:50vw; margin-left:26vw; margin-bottom:4vw; margin-top:4vw">
  <h3 style="font-size:2.3vw; margin-bottom:2vw; margin-top:3vw; height:auto ">* 회원 정보 검색 * </h3><br>
${error}
...
<img style="margin-top:5vw; width:50vw; padding:0.5vw;" src="images/main/m1.jpg"/>
</div>
