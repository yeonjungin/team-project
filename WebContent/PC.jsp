   ...
   <div id="event" style="margin-bottom:-1vw; width:auto">
    ...
    <header id="header">
        ...
        <div id="top-bar">
            ...
            <div class="container">
             <a href="./outside/mainpage2.jsp"><h3 style="color:white; width:15vw;font-size:2.7vw;  margin-top:2.8vw; margin-left:-2vw">용용전자</h3></a>
...
<div style="display:inline-block; margin-top:5vw; margin-left:0.6vw; margin-bottom:8vw">
		...
		Class.forName("com.mysql.cj.jdbc.Driver");
			...
			while(rs.next()){		
		%>
		<%if(rs.getString("P_DIVISION").equals("PC")){%>
