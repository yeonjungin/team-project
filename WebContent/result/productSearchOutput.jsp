  ...
  <nav id="menu" class="menu">
    <ul class="dropdown">
      ...
      <li ><a href="./BBs.jsp" title="Link">게시판</a></li>
	    ...
	    if(result1!=null) {
	    	%>
	    	<div style="text-align:center"><h2>${result1}</h2></div>
	    <%}else{
		%>
		<table class="type10" ><thead>
	   		<tr><th scope="cols">상품분류</th><th scope="cols">상품코드</th><th scope="cols">상품명</th><th scope="cols">가격</th><th scope="cols">이미지파일</th></tr></thead>
			
			 <tbody>
			        <tr><td class="even">${product.division}</td>
