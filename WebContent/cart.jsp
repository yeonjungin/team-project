...
<body class="home">
   <div id="event" style="margin-bottom:-1vw; width:auto">
    ...
    <header id="header">
        ...
        <div id="top-bar">
            ...
            <div class="container">
             <a href="./outside/mainpage2.jsp"><h3 style="color:white; width:15vw;font-size:2.7vw; margin-left:-2vw; margin-top:3.3vw">용용전자</h3></a>
  ...
  <nav id="menu" class="menu">
    <ul class="dropdown">
      <li ><a href="./TV.jsp" title="Link">TV/AV</a>
        <ul >
...
<section>
<%	ArrayList<CartVO> listOfCarts = (ArrayList<CartVO>)request.getAttribute("listOfCarts");
    		int sum = 0;
				if(!listOfCarts.isEmpty()){%>
<div class="container" style="margin-top:4vw; margin-bottom:10vw;">
    <div class="for-display"></div>
    <div class="display-target">
        <script src="http://www.webnoriter.com/~imsi/store/js/shop.js"></script>
        <div id="sod_bsk">
            
                <h1 id="hd_h1">장바구니</h1>
            <div class="tbl_head01 tbl_wrap">
                <table style="border:1xp solid red">
			<tr style="background-color:#BFA9CF; height:2.4vw">
               <th scope="col" style="text-align:center">상품 이미지</th>
               <th scope="col" style="text-align:center">상품명</th>
               <th scope="col" style="text-align:center">총수량</th>
               <th scope="col" style="text-align:center">판매가</th>
               <th scope="col" style="text-align:center">삭제하기</th>
             </tr>
			...
			<% 
				...
				CartVO cart = listOfCarts.get(i);
				 if(session.getAttribute("session_id").equals(cart.getLID())){
			    	  int total=cart.getUNITPRICE()*cart.getCOUNT();
			       		sum=sum+total;
			       		}
				...
				<tr>
					<td><img src="images/pro/<%=cart.getFILENAME() %>" style=" margin-top:1vw; margin-bottom:2vw;margin-left:4vw; width:10vw;"></td>
					<td style="text-align:center"><%=cart.getCNAME() %>
					<td style="text-align:center" ><%=cart.getCOUNT() %>	
					<td style="text-align:center"><%=cart.getUNITPRICE() %>
					<td style="text-align:center">
						<form action="p_delete.do" method="POST">
							<input type="hidden" name="product" value="<%=cart.getCNAME()%>">
							<button  class="btn btn-secondary" style="background-color:#B094D8; width:6vw ; margin-left:19.6vw" type="submit">삭제</button>
						</form>
					</td>
				</tr>
	...
	<% }
				...
				%>
	<div class="empty-container" style="display:flex; flex-wrap: wrap;">
 	<div class="for-display" style="width: 15%;"></div>
    <div class="display-target" style="width: 70%;">
        <script src="http://www.webnoriter.com/~imsi/store/js/shop.js"></script>
        <div id="sod_bsk">
            <h1 id="hd_h1" style="text-align:center">장바구니</h1>
            <div class="tbl_head01 tbl_wrap">
				<table style="width:100%;">
					<tr style="background-color:#BFA9CF; height:2.4vw">
		               ...
		               <th scope="col" style="text-align:center">삭제하기</th>
						...
						<tr style="margin-top:5vw; margin-bottom:5vw">
						<td></td>
						<td></td>
						<td style="text-align:center"> 장바구니가 비어있습니다.</td>
					</tr>
				</table>
			...
			<!-- </table> -->	
			  <div id="sod_bsk_act" style="text-align: center;">
              		<a href=./outside/mainpage2.jsp class="btn btn-secondary" style="background-color:purple; margin-top:5vw">쇼핑 계속하기</a>
              </div>
            <div id="sum" style="display:flex; justify-content: center;">
            	<h2 style="color:black; border:2px solid #cccccc; width:44vw; height:4vw; padding:1vw; text-align:center">총 금액 : <%=sum%>원 입니다.</h2>
            </div>
	     </div>
    </div>
    <div class="for-display" style="width: 15%;"></div>
